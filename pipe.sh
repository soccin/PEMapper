...
for FASTQ1 in $FASTQFILES; do
    ...
    QRUN 5 ${TAG}_MAP_03__$UUID HOLD ${TAG}_MAP_02__$UUID VMEM 32 LONG \
        picard.local AddOrReplaceReadGroups MAX_RECORDS_IN_RAM=10000000 CREATE_INDEX=true SO=coordinate \
...
QRUN 5 ${TAG}__05__FIXHDR HOLD ${TAG}__04__MERGE VMEM 32 LONG \
...
QRUN 2 ${TAG}__08_CLEANUP2 HOLD ${TAG}__05__FIXHDR VMEM 32 \
